namespace BHSoft.BHWeb.Common
{
    ...
    public class Utils
    {
        ...
        public static string GetPageNumbers(int curPage, int countPage, string url, int extendPage)
        {
            ...
            string str = "<a href=\"" + url + "&page=1\">&laquo;</a>&nbsp;";
            string str2 = string.Concat(new object[] { "<a href=\"", url, "&page=", countPage, "\">&raquo;</a>&nbsp;" });
            if (countPage < 1)
            {
                countPage = 1;
            }
        ...
        public static bool StrToBool(object strValue, bool defValue)
        {
            ...
            {
                return Convert.ToBoolean(strValue.ToString().ToLower());
            }
            return defValue;
        }
