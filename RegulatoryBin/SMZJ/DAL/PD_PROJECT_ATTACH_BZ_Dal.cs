namespace SMZJ.DAL
{
    ...
    public class PD_PROJECT_ATTACH_BZ_Dal
    {
        public void Add(PD_PROJECT_ATTACH_BZ_Model model)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into PD_PROJECT_ATTACH_BZ(");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from PD_PROJECT_ATTACH_BZ ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from PD_PROJECT_ATTACH_BZ");
            builder.Append(" where PD_PROJECT_CODE=:PD_PROJECT_CODE ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":PD_PROJECT_CODE", OracleType.VarChar, 50) };
            cmdParms[0].Value = PD_PROJECT_CODE;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            builder.Append(" FROM PD_PROJECT_ATTACH_BZ ");
            if (strWhere.Trim() != "")
            {
        ...
        public PD_PROJECT_ATTACH_BZ_Model GetModel(string PD_PROJECT_CODE)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select AUTO_NO,PD_PROJECT_CODE,PD_PROJECT_ATTACH_TYPE,PD_PROJECT_ATTACH_NAME,PD_PROJECT_ATTACH_NAME_SYSTEM from PD_PROJECT_ATTACH_BZ ");
            builder.Append(" where PD_PROJECT_CODE=:PD_PROJECT_CODE ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":PD_PROJECT_CODE", OracleType.VarChar, 50) };
            cmdParms[0].Value = PD_PROJECT_CODE;
            PD_PROJECT_ATTACH_BZ_Model model = new PD_PROJECT_ATTACH_BZ_Model();
        ...
        public bool Update(PD_PROJECT_ATTACH_BZ_Model model)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update PD_PROJECT_ATTACH_BZ set ");
            ...
            builder.Append(" where PD_PROJECT_CODE=:PD_PROJECT_CODE ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":AUTO_NO", OracleType.Char, 0x24), new OracleParameter(":PD_PROJECT_ATTACH_TYPE", OracleType.VarChar, 50), new OracleParameter(":PD_PROJECT_ATTACH_NAME", OracleType.VarChar, 50), new OracleParameter(":PD_PROJECT_ATTACH_NAME_SYSTEM", OracleType.VarChar, 50), new OracleParameter(":PD_PROJECT_CODE", OracleType.VarChar, 30) };
