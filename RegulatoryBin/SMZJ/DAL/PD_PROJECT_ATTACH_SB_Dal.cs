namespace SMZJ.DAL
{
    ...
    public class PD_PROJECT_ATTACH_SB_Dal
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from PD_PROJECT_ATTACH_SB ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from PD_PROJECT_ATTACH_SB");
            builder.Append(" where PD_PROJECT_CODE=:PD_PROJECT_CODE ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":PD_PROJECT_CODE", OracleType.VarChar, 50) };
            cmdParms[0].Value = PD_PROJECT_CODE;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            builder.Append(" FROM PD_PROJECT_ATTACH_SB ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select AUTO_NO,PD_PROJECT_CODE,PD_PROJECT_ATTACH_TYPE,PD_PROJECT_ATTACH_NAME,PD_PROJECT_ATTACH_NAME_SYSTEM from PD_PROJECT_ATTACH_SB ");
            builder.Append(" where PD_PROJECT_CODE=:PD_PROJECT_CODE ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":PD_PROJECT_CODE", OracleType.VarChar, 50) };
            cmdParms[0].Value = PD_PROJECT_CODE;
            PD_PROJECT_ATTACH_SB_Model model = new PD_PROJECT_ATTACH_SB_Model();
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update PD_PROJECT_ATTACH_SB set ");
