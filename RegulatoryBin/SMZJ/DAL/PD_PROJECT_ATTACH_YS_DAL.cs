namespace SMZJ.DAL
{
    ...
    public class PD_PROJECT_ATTACH_YS_DAL
    {
        public void Add(PD_PROJECT_ATTACH_YS_Model model)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into PD_PROJECT_ATTACH_YS(");
            builder.Append("PD_PROJECT_CODE,PD_PROJECT_ATTACH_TYPE,PD_PROJECT_ATTACH_NAME,PD_PROJECT_ATTACH_NAME_SYSTEM)");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from PD_PROJECT_ATTACH_YS ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from PD_PROJECT_ATTACH_YS");
            builder.Append(" where AUTO_NO=:AUTO_NO ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":AUTO_NO", OracleType.Number, 4) };
            cmdParms[0].Value = AUTO_NO;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            builder.Append(" FROM PD_PROJECT_ATTACH_YS ");
            if (strWhere.Trim() != "")
            {
        ...
        public int GetMaxId()
        {
            return DbHelperOra.GetMaxID("AUTO_NO", "PD_PROJECT_ATTACH_YS");
        }

        public PD_PROJECT_ATTACH_YS_Model GetModel(int AUTO_NO)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select AUTO_NO,PD_PROJECT_CODE,PD_PROJECT_ATTACH_TYPE,PD_PROJECT_ATTACH_NAME,PD_PROJECT_ATTACH_NAME_SYSTEM from PD_PROJECT_ATTACH_YS ");
            builder.Append(" where AUTO_NO=:AUTO_NO ");
            OracleParameter[] cmdParms = new OracleParameter[] { new OracleParameter(":AUTO_NO", OracleType.Number, 4) };
            cmdParms[0].Value = AUTO_NO;
            PD_PROJECT_ATTACH_YS_Model model = new PD_PROJECT_ATTACH_YS_Model();
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update PD_PROJECT_ATTACH_YS set ");
