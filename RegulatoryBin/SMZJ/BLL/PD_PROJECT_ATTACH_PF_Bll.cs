namespace SMZJ.BLL
{
    ...
    public class PD_PROJECT_ATTACH_PF_Bll
    {
        private readonly PD_PROJECT_ATTACH_PF_Dal dal = new PD_PROJECT_ATTACH_PF_Dal();
        ...
        public void AddList(List<PD_PROJECT_ATTACH_PF_Model> modelList)
        {
            foreach (PD_PROJECT_ATTACH_PF_Model model in modelList)
            {
                this.dal.Add(model);
            }
        }

        public List<PD_PROJECT_ATTACH_PF_Model> DataTableToList(DataTable dt)
        {
        ...
        public PD_PROJECT_ATTACH_PF_Model GetModelByCache(string PD_PROJECT_CODE)
        {
            string cacheKey = "PD_PROJECT_ATTACH_PFModel-" + PD_PROJECT_CODE;
            ...
            return (PD_PROJECT_ATTACH_PF_Model) cache;
        }

        public List<PD_PROJECT_ATTACH_PF_Model> GetModelList(string strWhere)
        {
