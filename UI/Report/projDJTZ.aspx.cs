...
public class Report_projDJTZ : Page, IRequiresSessionState
{
    ...
    protected void btnquery_Click(object sender, EventArgs e)
    {
        ...
        {
            strWhere = strWhere + "  and 申报单位 in('" + this.txtxzs.Value.Replace(",", "','") + "')";
        }
    ...
    {
        DataSet list = new ReportPublicBll().GetList(strWhere, "V_PD_PROJECT_TZ");
