...
window.open(url,name,'height='+iHeight+',,innerHeight='+iHeight+',width='+iWidth+',innerWidth='+iWidth+',top='+iTop+',left='+iLeft+',toolbar=no,menubar=no,scrollbars=auto,resizeable=no,location=no,status=no');
       ...
       {       var  year=document.getElementById("<%=ddlyear.ClientID %>").value; 
               var webFileUrl = "../Shared/DiagList/GetSession.aspx?tn="+val+"&year="+year;              
    ...
    <input type="hidden" id="hcode"  runat="server"/>
     ...
     年度：<asp:DropDownList ID="ddlyear" runat="server">
       ...
       &nbsp;&nbsp;   
      单位：<input  runat="server"  id="txtxz" onclick="javascript:openwindow('../Shared/DiagList/XzSelect.aspx','',300,400);" />
     &nbsp;&nbsp;
