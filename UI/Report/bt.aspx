<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation = "false" masterpagefile="~/Master/Report.master" CodeBehind="bt.aspx.cs" Inherits="bt" %>
...
<div class="ReportName">
    ...
    <span style="align-content:center" class="auto-style2"><strong>乡镇涉农专项资金使用情况表（补贴类资金）</strong></span>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="project_type_code" HeaderText="资金代码" Visible="true"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%" />
            <asp:BoundField HeaderText="资金名称" DataField="project_type_name" Visible="true"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%" />
            <asp:BoundField DataField="PD_PROJECT_BZNUM" HeaderText="补助数量"  Visible="true"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%"/>
            <asp:BoundField DataField="pd_project_bzmoney" HeaderText="金额" Visible="true"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%" />
        </Columns>
        </yyc:SmartGridView></div>
</asp:Content>
