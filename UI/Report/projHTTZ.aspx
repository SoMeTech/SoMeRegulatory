<%@ page language="C#" masterpagefile="~/Master/Report.master" autoeventwireup="true" inherits="Report_projHTTZ" title="项目合同台帐" enableEventValidation="false" stylesheettheme="Default" CodeBehind="projHTTZ.aspx.cs" %>
...
window.open(url,name,'height='+iHeight+',,innerHeight='+iHeight+',width='+iWidth+',innerWidth='+iWidth+',top='+iTop+',left='+iLeft+',toolbar=no,menubar=no,scrollbars=auto,resizeable=no,location=no,status=no');
    ...
    <input type="hidden" id="upk"  runat="server"/>
     ...
     年度：<asp:TextBox ID="txtyear" runat="server"></asp:TextBox>
       &nbsp;&nbsp;   
       所属单位：<input id="txtxz" runat="server"  onclick="javascript:openwindow('../Shared/DiagList/XzSelect.aspx','',300,400);" />
     &nbsp;&nbsp;&nbsp; 
       &nbsp;&nbsp;
...
&nbsp;<asp:Button ID="btnquery" runat="server" Text="查 询" OnClick="btnquery_Click" />
    ...
    <div class="ReportName">
        ...
        <asp:BoundField HeaderText="签定日期" DataField="合同日期"/>
        <asp:BoundField HeaderText="签约单位" DataField="合同签约单位代码"/>
        <asp:BoundField HeaderText="合同金额" DataField="合同金额"/>
        <asp:BoundField HeaderText="签约单位责任人" DataField="签约单位责任人"/>
        <asp:BoundField HeaderText="项目进度要求" DataField="项目进度要求"/>
        <asp:BoundField HeaderText="付款进度要求" DataField="付款进度要求"/>
        </Columns>
        </yyc:SmartGridView>
</asp:Content>