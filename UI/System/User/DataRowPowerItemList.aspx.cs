...
public class User_DataRowPowerItemList : Page, IRequiresSessionState
{
    public string count = "";
    private DB_OPT dbo;
    ...
    {
        string str = this.gvResult.DataKeys[e.RowIndex].Value.ToString();
        base.Response.Redirect("DataRowPowerItem.aspx?PK=" + str + "&type=Update");
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            {
                this.ShowData("");
                this.PageNavigator1.RecordCount = this.drpim.GetList("", this.dbo).Tables[0].Rows.Count;
