<%@ page language="C#" masterpagefile="~/Master/MainAddUpdate.master" autoeventwireup="true" CodeBehind="MenuUpdate.aspx.cs" title="Untitled Page" enableeventvalidation="false" stylesheettheme="Default" inherits="Menu_MenuUpdate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table border="0" cellpadding="4" cellspacing="0" class="menutext" cellspacing="0" cellpadding="0"
                        ...
                        <td style="width: 196px" align="left" height="30">
                            <label>
                                <span style="color: #000000">
                                    <asp:TextBox ID="txtfwqxbm" ReadOnly="true" runat="server" Width="200px" Style=" border: 1px solid #CCCCCC; background-color: #FFFFFF; padding:2px;" ></asp:TextBox></span></label>
                        </td>
                        <td style="width: 117px" align="right" height="30">
                            菜单路径
                        </td>
