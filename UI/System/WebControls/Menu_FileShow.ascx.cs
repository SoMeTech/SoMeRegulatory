...
public class Menu_FileShow : UserControl
{
    ...
    private void GetFiles(string strpath)
    {
        ...
        for (int i = 0; i < directories.Length; i++)
        {
            ...
            if (this.BDir(filename))
            {
                ...
                cell.Text = "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"" + this.ControlPage + "?filepath=" + base.Server.UrlEncode(s) + "\" target=\"" + this.WindowName + "\"><img border=\"0\" src=\"../menu/images/WJJ_S_0605_26.jpg\" width=\"18\">" + filename + "</a>";
                row.Cells.Add(cell);
                num++;
            }
        }
        for (int j = 0; j < files.Length; j++)
        {
            ...
            if (this.BFile(str3))
            {
                ...
                str4 = "images" + str4.Substring(str4.LastIndexOf("/"), str4.Length - str4.LastIndexOf("/"));
                cell2.Text = "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"#\" onclick=\"javascript:window.returnValue='" + str4 + "';window.close();\" target=\"file\"><img border=\"0\" src=\"../menu/images/WJ_B_0609_3.jpg\" width=\"15\">" + str3 + "</a>";
                row.Cells.Add(cell2);
                num++;
            }
        }
