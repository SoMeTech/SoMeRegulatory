<%@ page language="C#" masterpagefile="~/Master/One.master" autoeventwireup="true" CodeBehind="DataColumnList.aspx.cs" title="无标题页" enableeventvalidation="false" stylesheettheme="Default" inherits="SystemSetup_Dictionary_DataDic_DataColumnList" %>
        ...
        <input type="hidden" id="txttitle" runat="server" />
            <yyc:SmartGridView ID="gvResult" runat="server" AutoGenerateColumns="False" MouseOverCssClass="OverRow"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TablePK" HeaderText="表英文名" SortExpression="TablePK" />
                    <asp:BoundField DataField="ColumnRemark" HeaderText="字段中文名" SortExpression="ColumnRemark" />
                    <asp:BoundField DataField="ColumnName" HeaderText="字段英文名" SortExpression="ColumnName" />
