    ...
    <script type="text/javascript">
        function findwindow(val, num) {
            if (document.all['<%=txtssgs.ClientID %>'].value != "") {
                var webFileUrl = "../../../PublicMode/DiagList/GetSession.aspx?tn=" + val + "&&pk_corp=" + document.all['<%=txtssgspk.ClientID %>'].value + "";
            }
            else {
                if (num == '3') {
                    alert('请先选择单位再选择负责人！');
                ...
                <div style="width: 100%; height: 100%;">
                    <table width="100%">
                        ...
                        <tr height="30">
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtbmbh" runat="server" Width="200px" onblur="doCheck(this,'../../../PublicMode/DiagList/DisposeEvent.aspx?BH=','部门编号已经存在','1','checkBranchBH')"
