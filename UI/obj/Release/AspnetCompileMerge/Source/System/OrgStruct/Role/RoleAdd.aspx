...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="../../../Shared/jss/Check.js" type="text/javascript" charset="gb2312"></script>
                ...
                <div style=" width: 100%; height: 100%">
                    <table width="100%">
                        ...
                        <tr style="height: 40px">
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtjsbh" runat="server" Width="200px" onblur="doCheck(this,'../../../Shared/DiagList/DisposeEvent.aspx?BH=','编号已经存在','1','checkRoleBH')"
