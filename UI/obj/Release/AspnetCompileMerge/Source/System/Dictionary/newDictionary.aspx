...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="../../Shared/jss/Check.js" charset="gb2312"></script>
    ...
    <script type="text/javascript">
        ...
        function findwindow(num) {
            var webFileUrl = "../../Shared/DiagList/GetSession.aspx?tn=" + document.getElementById('<%=tableName.ClientID %>').value;
            //alert(webFileUrl);
        ...
        function doCheck(val, text, num, code) {
            if (document.all['<%=flog.ClientID %>'].value == 'add') {
                if (num == "1") {
                    checkIsRepeat(val, '../../Shared/DiagList/DisposeEvent.aspx?tableName=' + document.all['<%=tableName.ClientID %>'].value + '&BH=', text, document.all['<%=divbh.ClientID %>'], code);
                }
            }
        }
    </script>
