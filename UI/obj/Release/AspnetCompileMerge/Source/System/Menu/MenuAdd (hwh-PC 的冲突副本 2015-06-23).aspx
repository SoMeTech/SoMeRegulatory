                        ...
                        <td style="width: 196px" align="left" height="30">
                            <label>
                                <span style="color: #000000">
                                    <asp:TextBox ID="txtfwqxbm" runat="server" onblur="doCheck(this,'../../PublicMode/DiagList/DisposeEvent.aspx?PowerCode=','权限编码已经存在','1','CheckMenuPowerCode')" Width="200px" Style=" border: 1px solid #CCCCCC; background-color: #FFFFFF; padding:2px;"></asp:TextBox></span></label>
