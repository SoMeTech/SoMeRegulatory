<%@ page language="C#" autoeventwireup="true" CodeBehind="SelectDW.aspx.cs" inherits="Work_TongBu_SelectDW" enableEventValidation="false" stylesheettheme="Default" %>
  ...
  <script type="text/javascript">
   ...
   <div> 
    <asp:treeview ID="Treeview1" runat="server" ImageSet="XPFileExplorer" AutoGenerateDataBindings="false" ExpandDepth=0  
        OnTreeNodePopulate="Treeview1_TreeNodePopulate" ShowCheckBoxes="All"> 
