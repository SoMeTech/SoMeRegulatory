<%@ page language="C#" masterpagefile="~/Master/MainAddUpdate.master" autoeventwireup="true" title="新增考评细则" enableeventvalidation="false" stylesheettheme="Default"  CodeBehind="KaoPingTypeDetailSetAdd.aspx.cs" inherits="Work_KaoPing_KaoPingTypeDetailSetAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function findwindow(val, obj) {
            var webFileUrl = "../../../Shared/DiagList/GetSession.aspx?tn=pd_base_kaopingtype";
            //alert(webFileUrl);
            ...
            if (arr != null && arr != "false") {
                if (arr.indexOf("~") > 0) {
                    ...
                    //alert(ss);
                    try {
                        document.getElementById("<%=txtKHType.ClientID %>").value = ss[0];
                        obj.value = ss[1];
                    } catch (e) { alert(e) };
                }
            }
                ...
                <tbody>
                    ...
                    <tr height="40">
                        ...
                        <td style="width: 248px; text-align: left" height="30">
                            <asp:TextBox ID="txtKPContent" runat="server" Width="200px" Style="border: 1px solid #CCCCCC;
                                background-color: #FFFFFF; padding: 2px;"></asp:TextBox>
                        </td>
                        <td style="width: 113px" align="right" height="30">
                            扣分标准：<font color="red">*</font>
                        </td>
                        <td style="width: 196px" align="left" height="30">
