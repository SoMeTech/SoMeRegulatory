<%@ page language="C#" masterpagefile="~/Master/One.master" autoeventwireup="true" CodeBehind="ssXCList.aspx.cs" inherits="Work_projectGL_ssProjectCCXC_ssXCList" title="无标题页" enableEventValidation="false" stylesheettheme="Default" %>
        ...
        <ContentTemplate>
            ...
            <yyc:SmartGridView ID="gvResult" runat="server" AutoGenerateColumns="False" MouseOverCssClass="OverRow"
                ...
                <%--<Columns>
		            ...
		            <asp:BoundField DataField="ISCCXC" HeaderText="是否已巡查" SortExpression="ISCCXC" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Width="80px"/> 
                    ...
                    <asp:BoundField DataField="PD_PROJECT_YEARS" HeaderText="项目建设时限" SortExpression="PD_PROJECT_YEARS"
                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
                    <asp:BoundField DataField="PD_PROJECT_FILENO_LX" HeaderText="立项依据" Visible="false"
                        SortExpression="PD_PROJECT_FILENO_LX" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" />
