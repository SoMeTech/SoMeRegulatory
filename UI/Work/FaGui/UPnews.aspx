<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Master/MainAddUpdate.master" inherits="UPnews" CodeBehind="UPnews.aspx.cs" enableeventvalidation="false" validaterequest="false " stylesheettheme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="text-align: center;">
        <table id="t1" runat="server" style="width:90%;">
            <tr>
                        ...
                        <tr style="height: 50px;">
                            ...
                            <td style="text-align: left;">
                                <asp:TextBox ID="txtPD_PROJECT_SUBJECTS" runat="server" Style="border-color: #000000;
                                    width: 300px; border-style: none none groove none; border-width: 1px;" Font-Bold="True"
    ...
    <div id="t2" uid="t2" style=" width:100%;" runat="server">
        <table style="width: 90%;">
            ...
            <td style="width:5%;"></td>
                ...
                <table>
                    <tr>
                        <td style="width:70px; text-align:right;">附件下载：
                        </td>
                        <td>
            ...
            <td style="width:5%;"></td>
                <td>
                    <asp:Label ID="lblcont" uid="lblcont" runat="server" Text=""  ></asp:Label>
                </td>
            <td style="width:5%;"></td>
            </tr>
        </table>
...
<script type="text/javascript">
    function bindData() {
        if ($("div[uid='t2']").length > 0)
            Bind_tbHeadNotDel(eval($("input[uid='json_btData']").get(0).value)[0], 10000, 'zxzb_bt', 5);
        else
