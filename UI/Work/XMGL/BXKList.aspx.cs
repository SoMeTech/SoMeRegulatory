...
public class Work_GL_BXKList : Page, IRequiresSessionState
{
    ...
    public void ShowData(string str)
    {
        try
        {
            ...
            if (str != "")
            {
                str = " where " + str + " and  pd_project_isbxk=1 " + companyWhere;
            }
            else
            {
                str = "where  pd_project_isbxk=1 " + companyWhere;
            }
            DataSet ds = this.pagesize.pagesize("*", "view_pd_project_bxk_findlist", str, "pd_project_code", "", this.Master.PageIndex, this.Master.PageSize, out this.count);
