...
public class Work_projectJS_ssProjectGKGS_proJSGKGSList : Page, IRequiresSessionState
{
    ...
    public void Buttons(string ibtid)
    {
        ...
        switch (ibtid)
        {
            case "ibtcontrol_ibtlook":
                ...
                {
                    this.gvResult.DataKeys[selectedIndex].Value.ToString();
                    PageShowText.OpenPage("proJSGKGSMX.aspx?doType=looklist&UpdatePK=" + this.gvResult.DataKeys[selectedIndex].Value.ToString() + "&strTitle=项目建设资金公开公示", 0x556, 0x300, this.Page);
                    return;
                }
    ...
    protected void gvResult_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else
        {
            ...
            if (commandName != null)
            {
                ...
                {
                    num = int.Parse(e.CommandArgument.ToString());
                    PageShowText.OpenPage("proJSGKGSMX.aspx?UpdatePK=" + this.gvResult.DataKeys[num].Value.ToString() + "&strTitle=项目建设资金公开公示", 0x556, 0x300, this.Page);
                }
            }
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.txttitle.Value = "项目建设资金公开公示";
        }
    ...
    public void ShowData(string str)
    {
        try
        {
            ...
            DataSet ds = this.pagesize.pagesize("*", "V_PD_PROJECT_FINDLIST_GKGS_XM", str, "pd_project_code", "", this.Master.PageIndex, this.Master.PageSize, out this.count);
