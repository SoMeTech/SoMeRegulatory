<%@ page language="C#" masterpagefile="~/Master/MainMX_cs.master" autoeventwireup="true" CodeBehind="proJSGKGSMX.aspx.cs" inherits="Work_projectGL_ssProjectGKGS_proJSGKGSMX" title="项目建设资金公开公示" enableEventValidation="false" stylesheettheme="Default" %>
...
--%>
    ...
    <link href="../../../jquery.easyui/jquery-autocomplete/jquery.autocomplete.css" rel="stylesheet"
        type="text/css" />
    <script src="../../../jquery.easyui/jquery-autocomplete/jquery.autocomplete.js" type="text/javascript"></script>
             ...
             $('#img_delete').click(function () {
                 ...
                 try {
                     $.ajax({
                         ...
                         url: "proJSGKGSMX.aspx/DelImg", //调用WebService的地址和方法名称组合 ---- WsURL/方法名
             ...
             $('#btn_save').click(function () {
                 ...
                 try {
                     $.ajax({
                         type: "POST",   //访问WebService使用Post方式请求
                         contentType: "application/json", //WebService 会返回Json类型
                         url: "proJSGKGSMX.aspx/UpdateImgDscript", //调用WebService的地址和方法名称组合 ---- WsURL/方法名
    ...
    <script type="text/javascript">
        $().ready(function () {
            $.ajax({
                ...
                url: "proJSGKGSMX.aspx/GetGsxs",
                data: "{}",
                dataType: "json",
                success: function (msg) {
                    var datas = msg.d.split('|');
                    $("input[uid='txtPD_GS_STYLE']").autocomplete(
                                   datas
                                   , {
                                       minChars: 0,
                                       max: datas.length,
    ...
    <div style="text-align: left;">
        <div style="border: thin solid #8db2e3; margin-top: 15px; margin-left: 10px; margin-right: 5px;">
            ...
            <table border="0" style="width: auto;">
                ...
                <tr>
                    ...
                    <td align="left">
                        <input type="text" id="txtPD_YEAR" uid='txtPD_YEAR' runat="server" style="width: 200px;
                            color: #ffefff;" disabled="disabled" />
                    </td>
                    <td align="right">
                        项目名称 ：
                    </td>
                    <td align="left">
                        ...
                        <asp:TextBox ID="txtPD_PROJECT_NAME" runat="server" Style="width: 200px; color: #ffefff;"
                    ...
                    <td align="left">
                        <div style="display: none;">
                            <asp:TextBox ID="txt_PD_PROJECT_FILENO_LX" runat="server" Style="width: 200px;" Enabled="true"></asp:TextBox></div>
                        <asp:TextBox ID="txt_PD_PROJECT_YEARS" uid="txt_PD_PROJECT_YEARS" runat="server"
                            Enabled="false" Style="width: 200px;" Width="131px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <%--<td align="right" style="width: 130px; height: 40px;">
                    ...
                    <td align="left">
                        <asp:TextBox ID="txt_PD_PROJECT_ZJLY" runat="server" Style="width: 200px; color: #ffefff;"
                    ...
                    <td align="left">
                        <asp:TextBox ID="txt_PD_PROJECT_FZR" uid="txt_PD_PROJECT_FZR" runat="server" Enabled="false"
                            Style="width: 200px;" Width="82px"></asp:TextBox>
                    </td>
                    <td align="right">
                        受益人：
                    </td>
                    <td align="left">
                        <asp:TextBox ID="txt_PD_PROJECT_SYRS" uid="txt_PD_PROJECT_SYRS" runat="server" Enabled="false"
                            Style="width: 200px;" Width="82px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" colspan="3">
                        <input type="text" id="txt_PD_PROJECT_SSFW" uid="txt_PD_PROJECT_SSFW" runat="server"
                            disabled="disabled" style="width: 582px; height: 29px;" />&nbsp;
                    </td>
                    <td align="right" style="width: 130px; height: 40px;">
                        <%--  建设时限：--%>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" colspan="3">
                        <input type="text" id="txt_PD_PROJECT_CONTENT" uid="txt_PD_PROJECT_CONTENT" runat="server"
                            disabled="disabled" style="width: 582px; height: 29px;" />
                    </td>
                    <td align="right" style="width: 130px; height: 40px;">
                        &nbsp;
        ...
        <div style="width: 100%; height: auto;">
            <div style="width: 69%; height: auto; float: left;">
                <div style="border: thin solid #8db2e3; float: left; margin-top: 15px; width:100%; display:none;
                    margin-left: 10px; margin-right: 5px;">
                    <p style="margin-top: -8px;_margin-top: 5px; margin-left: 15px; background-color: White; width: 70px;">
                        投资构成：</p>
                    <table border="0" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="text" id="txt_PD_PROJECT_MONEY_TOTAL" uid="txt_PD_PROJECT_MONEY_TOTAL"
                                    runat="server" style="width: 200px;" readonly="readonly" />
                            </td>
                            <td align="right">
                                财政资金总额：
                            </td>
                            <td align="left">
                                <input type="text" id="txt_PD_PROJECT_MONEY_CZ_TOTAL" uid="txt_PD_PROJECT_MONEY_CZ_TOTAL"
                                    runat="server" style="width: 200px;" readonly="readonly" />
                            </td>
                            <td align="left" rowspan="5" colspan="2">
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 130px; height: 40px;">
                            ...
                            <td align="left">
                                <input type="text" id="txt_PD_PROJECT_MONEY_CZ_SJ" uid="txt_PD_PROJECT_MONEY_CZ_SJ"
                                    runat="server" style="width: 200px;" readonly="readonly" />
                            </td>
                            <td align="right">
                                本级财政资金：
                            ...
                            <td align="left">
                                <input type="text" id="txt_PD_PROJECT_MONEY_CZ_BJ" uid="txt_PD_PROJECT_MONEY_CZ_BJ"
                                    runat="server" style="width: 200px;" readonly="readonly" />
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="text" id="txt_PD_PROJECT_MONEY_ZC" uid="txt_PD_PROJECT_MONEY_ZC" runat="server"
                            ...
                            <td>
                                <input type="text" id="txt_PD_PROJECT_MONEY_QT" uid="txt_PD_PROJECT_MONEY_QT" runat="server"
                                    style="width: 200px;" readonly="readonly" />
                            </td>
                            <td>
                            </td>
                ...
                <div style="border: thin solid #8db2e3;   float: left; margin-top: 15px; width: 98%;
                    margin-left: 10px; margin-right: 5px;">
                    <p style="margin-top: -8px;_margin-top: 5px; margin-left: 15px; background-color: White; width: 100px;">
                        公开公示信息：</p>
                    <table border="0" style="width: 100%;">
                        <tr style="display: none;">
                            <td align="right" style="width: 130px; height: 40px;">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input type="text" id="txtPD_GS_DATE" data-options="formatter:myformatter,parser:myparser"
                                    ...
                                    style="width: 206px;" /><span style="color: Red">*</span>
                            </td>
                            <td align="right" style=" height: 40px;">
                                公示结束时间：
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3">
                                <input type="text" id="txtPD_GS_ADDR" uid='txtPD_GS_ADDR' runat="server" style="width: 535px;" />
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="3">
                                <input type="text" id="txtPD_GS_DETAIL" uid='txtPD_GS_DETAIL' runat="server" style="width: 535px;" />
                            </td>
                            <td>
                            </td>
                        </tr>
                    </table>
                    <input type="hidden" id="Hidden1" uid="json_btData" runat="server" />
                </div>
            </div>
            <div style="width: 23%; height: 500px; margin-right: 15px; float: right; ">
                <div style="width:100%; height: 270px; float: left; border: 1px solid #c0daf9;
                    margin-top: 15px; margin-left: 10px;">
                    <p style="margin-top: -7px; _margin-top:5px; margin-left: 50px; background-color: White; color: #333;
                        font-weight: bold; width: 125px;">
                        公开公示照片说明：</p>
                    <div id="demoContent">
                        <div class="ms">
                            描述：<input type="text" id="inp_discript" value="描述" />&nbsp;&nbsp;&nbsp;&nbsp;
                            <div style="display:none;"><input type="text" id="inp_discript_inp" value="描述" /><input type="text" id="inp_discript_id" value="描述" /></div>
