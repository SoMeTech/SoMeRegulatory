...
public class Work_projectGL_ssProjectCCXC_ssXCList : Page, IRequiresSessionState
{
    ...
    public void Buttons(string ibtid)
    {
        ...
        switch (ibtid)
        {
            case "ibtcontrol_ibtdo":
                ...
                {
                    PageShowText.OpenPage("ssXCMx.aspx?CCXCDoType=looklist&UpdatePK=" + this.gvResult.DataKeys[selectedIndex].Value.ToString() + "&strTitle=项目建设资金巡查", 0x556, 0x300, this.Page);
                    return;
                }
    ...
    protected void gvResult_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else
        {
            ...
            if (commandName != null)
            {
                ...
                {
                    num = int.Parse(e.CommandArgument.ToString());
                    PageShowText.OpenPage("ssXCMx.aspx?UpdatePK=" + this.gvResult.DataKeys[num].Value.ToString() + "&strTitle=" + base.Server.UrlEncode(this.txttitle.Value.Trim()), 0x556, 0x300, this.Page);
                }
            }
        }
    }
    ...
    public void ShowData(string str)
    {
        try
        {
            ...
            DataSet ds = this.pagesize.pagesize("*", "v_pd_project_findlist_cxxc_xm", str, "pd_project_code", "", this.Master.PageIndex, this.Master.PageSize, out this.count);
