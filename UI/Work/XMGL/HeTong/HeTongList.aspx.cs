...
public class Work_projectGL_HeTong_HeTongList : Page, IRequiresSessionState
{
    ...
    public void Buttons(string ibtid)
    {
        ...
        switch (ibtid)
        {
            case "ibtcontrol_ibtadd":
                PageShowText.OpenPage("HeTongMx.aspx?doType=add&strTitle=" + base.Server.UrlEncode(this.txttitle.Value.Trim()), 0x556, 0x300, this.Page);
                return;

            case "ibtcontrol_ibtupdate":
                PageShowText.OpenPage("HeTongMx.aspx?UpdatePK=" + this.gvResult.DataKeys[selectedIndex].Value.ToString() + "&doType=update&strTitle=" + base.Server.UrlEncode(this.txttitle.Value.Trim()), 0x556, 0x300, this.Page);
                return;
            ...
            case "ibtcontrol_ibtlook":
                ...
                {
                    PageShowText.OpenPage("HeTongMx.aspx?UpdatePK=" + this.gvResult.DataKeys[selectedIndex].Value.ToString() + "&doType=look&strTitle=" + base.Server.UrlEncode(this.txttitle.Value.Trim()), 0x556, 0x300, this.Page);
                    return;
                }
    ...
    protected void gvResult_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else
        {
            ...
            if (commandName != null)
            {
                ...
                {
                    num = int.Parse(e.CommandArgument.ToString());
                    PageShowText.OpenPage("HeTongMx.aspx?UpdatePK=" + this.gvResult.DataKeys[num].Value.ToString() + "&strTitle=" + base.Server.UrlEncode(this.txttitle.Value.Trim()), null, null, this.Page);
                }
            }
        }
    }
    ...
    {
        PageUsuClass.PageChangControl(nPageIndex, "view_contract_list", this.Page);
    }
    ...
    {
        PageUsuClass.SearchControl(strselect, strcloname, strsql, this.pageind, "view_contract_list", this.Page);
    }
    ...
    public void ShowData(string str)
    {
        try
        {
            ...
            DataSet ds = this.pagesize.pagesize("*", "view_contract_list", str, "pd_project_code", "", this.Master.PageIndex, this.Master.PageSize, out this.count);
