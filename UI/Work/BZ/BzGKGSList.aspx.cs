...
public class Work_BZ_projBzGKGSList : Page, IRequiresSessionState
{
    ...
    public void Buttons(string ibtid)
    {
        ...
        switch (ibtid)
        {
            case "ibtcontrol_ibtadd":
                PageShowText.OpenPage("SbMx.aspx", 0x556, 0x300, this.Page);
                break;
            ...
            case "ibtcontrol_ibtdo":
                ...
                PageShowText.OpenPage("SSMx.aspx?UpdatePK=" + this.gvResult.DataKeys[selectedIndex].Value.ToString() + "&strTitle=" + base.Server.UrlEncode(this.txttitle.Value.Trim()), 0x556, 0x300, this.Page);
                return;
