<%@ control language="C#" autoeventwireup="true" inherits="WebControls_PowerServices" CodeBehind="PowerServices.ascx.cs" %>
...
<fieldset style="font-size:9pt; height:370px; width:300px;">
    <legend style="color:red">业务权限列表</legend>
    <div style="width:300px; height:360px; overflow-y:scroll;">
